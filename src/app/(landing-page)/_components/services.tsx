...
const services = [
    {
        ...
        description: "We focus on steady growth, and building your online reputation over time in a way that looks organic and authentic."
    },
    {
        icon: <AdressError />,
        title: "Dispute Negative/Invalid Reviews",
        description: "We dispute negative and Invalid reviews using legitimate platform processes in order to improve your average rating."
    },
    {
        icon: <RespondIcon />,
        title: "Respond to Customer Feedback",
        description: "We deliver timely replies to every review to strengthen trust and credibility."
    }
]
        ...
        <section className="bg-light-background">
            <Wrapper className="relative flex flex-col justify-center items-center py-[6.3rem] gap-y-[4rem]">
                <header className="flex flex-col items-center">
                    ...
                    <p className="text-grey-600 text-center md:text-start">Show up with credibility wherever customers are sharing their experiences.</p>
                </header>
